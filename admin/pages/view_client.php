                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                                    <a href="profile.php" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        ...
                                        print' <img class="img-circle avatar" width="60" height="60" src="pages/'.$myavatar.'" alt="'.$myfname.'">';    
                                        }
        ...
        <li> <a  href="../CreateTech.php"><i class="fas fa-users-cog"></i>Technicians</a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Client - <?php echo "$sdfname"; ?> <?php echo "$sdlname"; ?></h3>
                    ...
                    <div class="row">
						...
						<div class="row">
                            <div class="col-md-5">
                                ...
                                <?php 
						        if ($sdavatar == NULL) {
						        print' <img width="180"  class="img-responsive" src="../../images/'.$sdgender.'.png" alt="'.$sdfname.'">';
						        }else{
							...
							<div class="col-md-7">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
									<h3><?php echo "$sdfname"; ?>'s Tickets</h3>
